package org.hamedabdelhaq.spark.demos
...
// Create a Scala Maven application for Apache Spark
//// https://docs.microsoft.com/en-us/azure/hdinsight/spark/apache-spark-create-standalone-application

// Maven:
//// Download from https://maven.apache.org/download.cgi
//// unpack and place the folder in the intended location
//// copy the path of the bin folder and attach it to the end of the 'path' system variable

// creating a jar file from maven-based scala project
////
